...
check( 'largeur : défaut form_max_width 1000 px (réglages + rendu)', false !== strpos( $set5, "'form_max_width'        => 620" ) && false !== strpos( $fm8, "'form_max_width', 620" ) );
...
check( 'anti-leak : classe + journal + trace', file_exists( $plugin_dir . 'includes/core/class-anti-leak.php' ) && false !== strpos( file_get_contents( $plugin_dir . 'includes/core/class-anti-leak.php' ), 'log_export' ) && false !== strpos( file_get_contents( $plugin_dir . 'includes/core/class-anti-leak.php' ), 'trace_code' ) );
check( 'anti-leak : alerte e-mail export massif', false !== strpos( file_get_contents( $plugin_dir . 'includes/core/class-anti-leak.php' ), 'export_alert_min' ) );
...
check( 'anti-leak : intégrité fichiers + avis admin', false !== strpos( file_get_contents( $plugin_dir . 'includes/core/class-anti-leak.php' ), 'maybe_integrity_check' ) && false !== strpos( file_get_contents( $plugin_dir . 'includes/core/class-anti-leak.php' ), 'integrity_notice' ) );
$set_page = file_get_contents( $plugin_dir . 'includes/admin/pages/class-settings-page.php' );
