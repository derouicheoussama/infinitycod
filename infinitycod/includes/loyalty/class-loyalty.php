...
class Loyalty {
	...
	public static function available_points( $phone ) {
		...
		// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared, PluginCheck.Security.DirectDB.UnescapedDBParameter -- agrégat temps réel requis pour le solde ; valeurs paramétrées via %s ; {$orders} = nom de table issu du schéma interne (jamais d'entrée utilisateur).
