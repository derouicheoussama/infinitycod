...
CREATE TABLE IF NOT EXISTS webhook_events (
	id INTEGER PRIMARY KEY AUTOINCREMENT, provider TEXT NOT NULL DEFAULT 'freemius',
	event_key TEXT NOT NULL, type TEXT DEFAULT '', status TEXT NOT NULL DEFAULT 'RECEIVED',
